...
> = {
  ...
  fa: {
    wer: "`Wer` دربارهٔ شخص یا فاعل جمله می‌پرسد.",
    ...
    welche: "`Welche` برای انتخاب از یک مجموعهٔ مشخص به کار می‌رود.",
    ...
    womit: "`Womit` دربارهٔ وسیله، ابزار یا روش می‌پرسد.",
    worueber:
      "`Worüber` دربارهٔ موضوعی می‌پرسد که کسی درباره‌اش صحبت می‌کند، فکر می‌کند یا می‌نویسد.",
    woran:
      "`Woran` می‌پرسد کسی روی چه چیزی کار می‌کند، به چه چیزی فکر می‌کند یا از چه چیزی می‌توان چیزی را شناخت.",
    wofuer: "`Wofür` دربارهٔ هدف، کاربرد یا منظورِ چیزی می‌پرسد.",
  },
  ar: {
    ...
    wie: "`Wie` يسأل عن الطريقة أو الحالة أو الكيفية.",
    ...
    womit: "`Womit` يسأل عن الوسيلة أو الأداة أو الطريقة.",
    worueber:
      "`Worüber` يسأل عن الموضوع الذي يتحدث عنه شخص ما أو يفكر فيه أو يكتب عنه.",
    woran:
      "`Woran` يسأل عمّا يعمل عليه شخص ما أو يفكر فيه أو عمّا يمكن التعرّف به على شيء.",
    wofuer: "`Wofür` يسأل عن الغرض أو الاستخدام أو ما خُصص له الشيء.",
  },
  sq: {
