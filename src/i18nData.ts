const MESSAGES_BASE = {
  de: {
    ...
    userPostCoverHint: "Cover / Thumbnail (optional JPG/PNG)",
    userPostCoverClear: "Cover entfernen",
  ...
  en: {
    ...
    organizerShortsEmpty: "No shorts yet.",
    userPinnedShortLabel: "Pinned short",
    userPinShort: "Pin short",
    userUnpinShort: "Unpin short",
    ...
    userPostCoverHint: "Cover / thumbnail (optional JPG/PNG)",
    userPostCoverClear: "Clear cover",
  ...
  ru: {
    ...
    userPostCoverHint: "Обложка / thumbnail (необязательно JPG/PNG)",
    userPostCoverClear: "Убрать обложку",
  ...
  uk: {
    ...
    userPostCoverHint: "Обкладинка / thumbnail (необов'язково JPG/PNG)",
    userPostCoverClear: "Прибрати обкладинку",
